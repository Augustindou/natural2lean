...
class TestTheorem(unittest.TestCase):
    def test_theorem_examples(self):
        ...
        th_lean_1 = "theorem square_of_even_number_is_even (m : Nat) (h₀ : even (m)) : even (m^2) := by\n"
        th_lean_2 = "theorem square_mod_3 (q : Nat) (h₀ : ¬ divisible (3) (q)) : q^2 % 3 = 1 := by\n"
        th_lean_3 = "theorem square_of_q_divisible_by_3_means_q_is_divisible_by_3 (q : Nat) (h₀ : divisible (3) (q^2)) : divisible (3) (q) := by\n"
